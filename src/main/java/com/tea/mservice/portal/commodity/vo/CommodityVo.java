package com.tea.mservice.portal.commodity.vo;
...
public class CommodityVo extends IdEntity {
	...
	private Character pickYear;//采摘年份
	private Character pickSeason;//采摘季节
	private Character goodsGrade;//商品等级;
	...
	public Character getPickYear() {
		return pickYear;
	}
	public void setPickYear(Character pickYear) {
		this.pickYear = pickYear;
	}
	public Character getPickSeason() {
		return pickSeason;
	}
	public void setPickSeason(Character pickSeason) {
		this.pickSeason = pickSeason;
	}
	public Character getGoodsGrade() {
		return goodsGrade;
	}
	public void setGoodsGrade(Character goodsGrade) {
