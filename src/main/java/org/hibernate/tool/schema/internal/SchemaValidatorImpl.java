...
public class SchemaValidatorImpl implements SchemaValidator {
	...
	protected void validateColumnType(
		...
		//add by alex
		// it is for exception: SchemaManagementException wrong column type encountered 
		String columnType = column.getSqlType( dialect, metadata ).toLowerCase(Locale.ROOT);
